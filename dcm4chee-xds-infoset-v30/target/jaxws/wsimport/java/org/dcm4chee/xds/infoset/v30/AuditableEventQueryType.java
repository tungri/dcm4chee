    ...
    extends RegistryObjectQueryType
{
    ...
    @XmlElement(name = "AffectedObjectQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<RegistryObjectQueryType> affectedObjectQuery;
    @XmlElement(name = "EventTypeQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected ClassificationNodeQueryType eventTypeQuery;
    @XmlElement(name = "UserQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
