    ...
    extends RegistryObjectQueryType
{
    ...
    @XmlElement(name = "AddressFilter", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<FilterType> addressFilter;
    @XmlElement(name = "TelephoneNumberFilter", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<FilterType> telephoneNumberFilter;
    @XmlElement(name = "EmailAddressFilter", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<FilterType> emailAddressFilter;
    @XmlElement(name = "ParentQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected OrganizationQueryType parentQuery;
    @XmlElement(name = "ChildOrganizationQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<OrganizationQueryType> childOrganizationQuery;
    @XmlElement(name = "PrimaryContactQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
