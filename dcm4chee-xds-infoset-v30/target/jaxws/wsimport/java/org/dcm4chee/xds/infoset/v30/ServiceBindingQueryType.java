    ...
    extends RegistryObjectQueryType
{
    ...
    @XmlElement(name = "ServiceQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected ServiceQueryType serviceQuery;
    @XmlElement(name = "SpecificationLinkQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<SpecificationLinkQueryType> specificationLinkQuery;
    @XmlElement(name = "TargetBindingQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
