    ...
    extends RegistryObjectQueryType
{
    ...
    @XmlElement(name = "AssociationTypeQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected ClassificationNodeQueryType associationTypeQuery;
    @XmlElement(name = "SourceObjectQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected RegistryObjectQueryType sourceObjectQuery;
    @XmlElement(name = "TargetObjectQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
