    ...
    extends RegistryObjectQueryType
{
    ...
    @XmlElement(name = "UsageDescriptionBranch", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected InternationalStringBranchType usageDescriptionBranch;
    @XmlElement(name = "ServiceBindingQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected ServiceBindingQueryType serviceBindingQuery;
    @XmlElement(name = "SpecificationObjectQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
