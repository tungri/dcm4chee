    ...
    extends RegistryObjectQueryType
{
    ...
    @XmlElement(name = "ChildrenQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<ClassificationNodeQueryType> childrenQuery;
    @XmlElement(name = "NodeTypeQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
