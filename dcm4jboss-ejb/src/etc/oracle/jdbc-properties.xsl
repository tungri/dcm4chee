...
QuerySeriesAttrsForRetrieveCmd=SELECT patient.pat_attrs,study.study_attrs,series.series_attrs,patient.pat_id,patient.pat_name,study.study_iuid,series.updated_time FROM patient,study,series WHERE patient.pk=study.patient_fk AND study.pk=series.study_fk AND series.series_iuid=?
