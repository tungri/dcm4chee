    ...
    extends RegistryObjectQueryType
{
    ...
    @XmlElement(name = "RegistryObjectQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected RegistryObjectQueryType registryObjectQuery;
    @XmlElement(name = "IdentificationSchemeQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
