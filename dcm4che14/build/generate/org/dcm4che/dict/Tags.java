...
public class Tags {
    ...
    public static final int RefRelatedGeneralSOPClassUIDInFile = 0x0004151A;
    ...
    public static final int IssuerOfAccessionNumberSeq = 0x00080051;
    ...
    /** (0008,0062) VR=UI SOP Classes in Study */
    ...
    public static final int RefWaveformSeq = 0x0008113A;
    ...
    /** (0008,114B) VR=SQ Referenced Real World Value Mapping Instance Sequence */
    public static final int RefRealWorldValueMappingInstanceSeq = 0x0008114B;
    ...
    /** (0008,1161) VR=UL Simple Frame List */
    ...
    public static final int StudiesContainingOtherRefInstancesSeq = 0x00081200;

    /** (0008,1250) VR=SQ Related Series Sequence */
    public static final int RelatedSeriesSeq = 0x00081250;
    ...
    /** (0008,9410) VR=SQ Referenced Other Plane Sequence */
    public static final int RefOtherPlaneSeq = 0x00089410;

    /** (0008,9458) VR=SQ Frame Display Sequence */
    public static final int FrameDisplaySeq = 0x00089458;
    ...
    /** (0008,9460) VR=CS Skip Frame Range Flag */
    ...
    public static final int PatientPrimaryLanguageCodeSeq = 0x00100101;

    /** (0010,0102) VR=SQ Patient's Primary Language Code Modifier Sequence */
    public static final int PatientPrimaryLanguageModifierCodeSeq = 0x00100102;
    ...
    /** (0010,1002) VR=SQ Other Patient ID Sequence */
    public static final int OtherPatientIDSeq = 0x00101002;
    ...
    public static final int PatientSpeciesCodeSeq = 0x00102202;
    ...
    public static final int PatientBreedCodeSeq = 0x00102293;

    /** (0010,2294) VR=SQ Breed Registration Sequence */
    public static final int BreedRegistrationSeq = 0x00102294;
    ...
    public static final int BreedRegistryCodeSeq = 0x00102296;

    /** (0010,2297) VR=PN Responsible Person */
    public static final int ResponsiblePerson = 0x00102297;

    /** (0010,2298) VR=CS Responsible Person Role */
    public static final int ResponsiblePersonRole = 0x00102298;

    /** (0010,2299) VR=LO Responsible Organization */
    ...
    public static final int DeIdentificationMethodCodeSeq = 0x00120064;
    ...
    public static final int ConsentForClinicalTrialUseSeq = 0x00120083;
    ...
    /** (0018,1008) VR=LO Ganty ID */
    public static final int GantyID = 0x00181008;
    ...
    /** (0018,115E) VR=DS Image and Fluoroscopy Area DoseProduct */
    ...
    /** (0018,1412) VR=DS Target Exposure Index */
    ...
    /** (0018,1624) VR=US Shutter Presentation Color CIELab Value */
    ...
    /** (0018,9185) VR=ST Respiratory Motion Compensation Technique Description */
    public static final int RespiratoryMotionCompensationTechniqueDescription = 0x00189185;

    /** (0018,9186) VR=ST Respiratory Signal Source ID */
    ...
    public static final int CTDIPhantomTypeCodeSeq = 0x00189346;

    /** (0018,9401) VR=SQ Projection Pixel Calibration Sequence */
    public static final int ProjectionPixelCalibrationSeq = 0x00189401;
    ...
    public static final int PositionerPositionSeq = 0x00189405;

    /** (0018,9406) VR=SQ Table Position Sequence */
    public static final int TablePositionSeq = 0x00189406;

    /** (0018,9407) VR=SQ Collimator Shape Sequence */
    public static final int CollimatorShapeSeq = 0x00189407;

    /** (0018,9412) VR=SQ XA/XRF Frame Characteristics Sequence */
    public static final int XAXRFFrameCharacteristicsSeq = 0x00189412;

    /** (0018,9417) VR=SQ Frame Acquisition Sequence */
    public static final int FrameAcquisitionSeq = 0x00189417;

    /** (0018,9420) VR=CS X-Ray Receptor Type */
    ...
    public static final int ExposureControlSensingRegionsSeq = 0x00189434;
    ...
    /** (0018,9442) VR=SS Vertices of the Polygonal Exposure Control Sensing Region */
    ...
    public static final int FrameDetectorParametersSeq = 0x00189451;
    ...
    public static final int CalibrationSeq = 0x00189455;

    /** (0018,9456) VR=SQ Object Thickness Sequence */
    public static final int ObjectThicknessSeq = 0x00189456;
    ...
    public static final int FieldOfViewDimensionInFloat = 0x00189461;

    /** (0018,9462) VR=SQ Isocenter Reference System Sequence */
    public static final int IsocenterReferenceSystemSeq = 0x00189462;
    ...
    /** (0018,9726) VR=FD Transverse Detector Separation */
    ...
    public static final int PETFrameAcquisitionSeq = 0x00189732;

    /** (0018,9733) VR=SQ PET Detector Motion Details Sequence */
    public static final int PETDetectorMotionDetailsSeq = 0x00189733;

    /** (0018,9734) VR=SQ PET Table Dynamics Sequence */
    public static final int PETTableDynamicsSeq = 0x00189734;

    /** (0018,9735) VR=SQ PET Position Sequence */
    public static final int PETPositionSeq = 0x00189735;

    /** (0018,9736) VR=SQ PET Frame Correction Factors Sequence */
    public static final int PETFrameCorrectionFactorsSeq = 0x00189736;

    /** (0018,9737) VR=SQ Radiopharmaceutical Usage Sequence */
    public static final int RadiopharmaceuticalUsageSeq = 0x00189737;
    ...
    public static final int PETReconstructionSeq = 0x00189749;

    /** (0018,9751) VR=SQ PET Frame Type Sequence */
    public static final int PETFrameTypeSeq = 0x00189751;

    /** (0018,9755) VR=CS Time of Flight Information Used */
    ...
    /** (0018,9760) VR=CS Scatter Corrected */
    ...
    /** (0018,9767) VR=CS Sensitivity Calibrated */
    ...
    public static final int PatientPhysiologicalStateSeq = 0x00189771;

    /** (0018,9772) VR=SQ Patient Physiological State Code Sequence */
    public static final int PatientPhysiologicalStateCodeSeq = 0x00189772;

    /** (0018,9801) VR=FD Depth(s) of Focus */
    public static final int DepthOfFocus = 0x00189801;

    /** (0018,9803) VR=SQ Excluded Intervals Sequence */
    public static final int ExcludedIntervalsSeq = 0x00189803;
    ...
    /** (0018,9806) VR=SQ US Image Description Sequence */
    public static final int USImageDescriptionSeq = 0x00189806;

    /** (0018,9807) VR=SQ Image Data Type Sequence */
    public static final int ImageDataTypeSeq = 0x00189807;

    /** (0018,9808) VR=CS Data Type */
    public static final int DataType = 0x00189808;

    /** (0018,9809) VR=SQ Transducer Scan Pattern Code Sequence */
    public static final int TransducerScanPatternCodeSeq = 0x00189809;
    ...
    /** (0018,980D) VR=SQ Transducer Geometry Code Sequence */
    public static final int TransducerGeometryCodeSeq = 0x0018980D;

    /** (0018,980E) VR=SQ Transducer Beam Steering Code Sequence */
    public static final int TransducerBeamSteeringCodeSeq = 0x0018980E;

    /** (0018,980F) VR=SQ Transducer Application Code Sequence */
    public static final int TransducerApplicationCodeSeq = 0x0018980F;
    ...
    /** (0020,9307) VR=CS Ultrasound Acquisition Geometry */
    ...
    /** (0020,9309) VR=FD Volume to Transducer Mapping Matrix */
    public static final int VolumeToTransducerMappingMatrix = 0x00209309;

    /** (0020,930A) VR=FD Volume to Table Mapping Matrix */
    ...
    /** (0020,930D) VR=FD Temporal Position Time Offset */
    public static final int TemporalPositionTimeOffset = 0x0020930D;

    /** (0020,930E) VR=SQ Plane Position (Volume) Sequence */
    public static final int PlanePositionVolumeSeq = 0x0020930E;

    /** (0020,930F) VR=SQ Plane Orientation (Volume) Sequence */
    public static final int PlaneOrientationVolumeSeq = 0x0020930F;

    /** (0020,9310) VR=SQ Temporal Position Sequence */
    public static final int TemporalPositionSeq = 0x00209310;

    /** (0020,9311) VR=CS Dimension Organization Type */
    public static final int DimensionOrganizationType = 0x00209311;

    /** (0020,9312) VR=UI Volume Frame of Reference UID */
    public static final int VolumeFrameOfReferenceUID = 0x00209312;

    /** (0020,9313) VR=UI Table Frame of Reference UID */
    ...
    public static final int PatientOrientationInFrameSeq = 0x00209450;
    ...
    public static final int PatientEyeMovementCommandCodeSeq = 0x00220006;

    /** (0022,0007) VR=FL Spherical Lens Power */
    ...
    /** (0022,0010) VR=FL Stereo Baseline Angle */
    public static final int StereoBaselineAngle = 0x00220010;

    /** (0022,0011) VR=FL Stereo Baseline Displacement */
    public static final int StereoBaselineDisplacement = 0x00220011;

    /** (0022,0012) VR=FL Stereo Horizontal Pixel Offset */
    public static final int StereoHorizontalPixelOffset = 0x00220012;

    /** (0022,0013) VR=FL Stereo Vertical Pixel Offset */
    public static final int StereoVerticalPixelOffset = 0x00220013;

    /** (0022,0014) VR=FL Stereo Rotation */
    public static final int StereoRotation = 0x00220014;

    /** (0022,0015) VR=SQ Acquisition Device Type Code Sequence */
    public static final int AcquisitionDeviceTypeCodeSeq = 0x00220015;

    /** (0022,0016) VR=SQ Illumination Type Code Sequence */
    public static final int IlluminationTypeCodeSeq = 0x00220016;

    /** (0022,0017) VR=SQ Light Path Filter Type Stack Code Sequence */
    public static final int LightPathFilterTypeStackCodeSeq = 0x00220017;

    /** (0022,0018) VR=SQ Image Path Filter Type Stack Code Sequence */
    public static final int ImagePathFilterTypeStackCodeSeq = 0x00220018;

    /** (0022,0019) VR=SQ Lenses Code Sequence */
    public static final int LensesCodeSeq = 0x00220019;

    /** (0022,001A) VR=SQ Channel Description Code Sequence */
    public static final int ChannelDescriptionCodeSeq = 0x0022001A;

    /** (0022,001B) VR=SQ Refractive State Sequence */
    public static final int RefractiveStateSeq = 0x0022001B;

    /** (0022,001C) VR=SQ Mydriatic Agent Code Sequence */
    public static final int MydriaticAgentCodeSeq = 0x0022001C;

    /** (0022,001D) VR=SQ Relative Image Position Code Sequence */
    public static final int RelativeImagePositionCodeSeq = 0x0022001D;

    /** (0022,0020) VR=SQ Stereo Pairs Sequence */
    public static final int StereoPairsSeq = 0x00220020;

    /** (0022,0021) VR=SQ Left Image Sequence */
    public static final int LeftImageSeq = 0x00220021;

    /** (0022,0022) VR=SQ Right Image Sequence */
    public static final int RightImageSeq = 0x00220022;
    ...
    public static final int OphthalmicFrameLocationSeq = 0x00220031;

    /** (0022,0032) VR=FL Reference Coordinates */
    ...
    public static final int MydriaticAgentConcentrationUnitsSeq = 0x00220042;
    ...
    /** (0022,0058) VR=SQ Name Mydriatic Agent Sequence */
    public static final int NameMydriaticAgentSeq = 0x00220058;

    /** (0028,0002) VR=US Samples per Pixel */
    public static final int SamplesPerPixel = 0x00280002;

    /** (0028,0003) VR=US Samples per Pixel Used */
    ...
    public static final int AlphaPaletteColorLUTDescriptor = 0x00281104;
    ...
    public static final int AlphaPaletteColorLUTData = 0x00281204;

    /** (0028,1214) VR=UI Large Palette Color Lookup Table UID */
    public static final int LargePaletteColorLUTUID = 0x00281214;
    ...
    public static final int DataFrameAssignmentSeq = 0x00281401;
    ...
    public static final int BitsMappedToColorLUT = 0x00281403;

    /** (0028,1404) VR=SQ Blending LUT 1 Sequence */
    public static final int BlendingLUT1Seq = 0x00281404;
    ...
    public static final int BlendingLUTDescriptor = 0x00281407;

    /** (0028,1408) VR=OW Blending Lookup Table Data */
    public static final int BlendingLUTData = 0x00281408;

    /** (0028,140B) VR=SQ Enhanced Palette Color Lookup Table Sequence */
    public static final int EnhancedPaletteColorLUTSeq = 0x0028140B;

    /** (0028,140C) VR=SQ Blending LUT 2 Sequence */
    public static final int BlendingLUT2Seq = 0x0028140C;
    ...
    /** (0028,140F) VR=CS RGB LUT Transfer Function */
    ...
    /** (0028,7FE0) VR=UT Pixel Data Provider URL */
    ...
    public static final int FramePixelShiftSeq = 0x00289415;

    /** (0028,9416) VR=US Subtraction Item ID */
    public static final int SubtractionItemID = 0x00289416;

    /** (0028,9422) VR=SQ Pixel Intensity Relationship LUT Sequence */
    public static final int PixelIntensityRelationshipLUTSeq = 0x00289422;

    /** (0028,9443) VR=SQ Frame Pixel Data Properties Sequence */
    public static final int FramePixelDataPropertiesSeq = 0x00289443;
    ...
    public static final int PixelShiftSeq = 0x00289501;

    /** (0028,9502) VR=SQ Region Pixel Shift Sequence */
    public static final int RegionPixelShiftSeq = 0x00289502;

    /** (0028,9503) VR=SS Vertices of the Region */
    public static final int VerticesOfTheRegion = 0x00289503;

    /** (0028,9505) VR=SQ Multi-frame Presentation Sequence */
    public static final int MultiFramePresentationSeq = 0x00289505;

    /** (0028,9506) VR=US Pixel Shift Frame Range */
    public static final int PixelShiftFrameRange = 0x00289506;

    /** (0028,9507) VR=US Name LUT Frame Rang */
    public static final int NameLUTFrameRang = 0x00289507;
    ...
    public static final int IssuerOfAdmissionIDRetired = 0x00380011;

    /** (0038,0014) VR=SQ Issuer of Admission ID Sequence */
    public static final int IssuerOfAdmissionIDSeq = 0x00380014;
    ...
    /** (0038,0060) VR=LO Service Episode ID */
    ...
    /** (0038,0062) VR=LO Service Episode Description */
    public static final int ServiceEpisodeDescription = 0x00380062;

    /** (0038,0064) VR=SQ Issuer of Service Episode ID Sequence */
    public static final int IssuerOfServiceEpisodeIDSeq = 0x00380064;

    /** (0038,0100) VR=SQ Pertinent Documents Sequence */
    public static final int PertinentDocumentsSeq = 0x00380100;
    ...
    public static final int AssigningFacilitySeq = 0x00400036;

    /** (0040,0039) VR=SQ Assigning Jurisdiction Code Sequence */
    public static final int AssigningJurisdictionCodeSeq = 0x00400039;

    /** (0040,003A) VR=SQ Assigning Agency or Department Code Sequence */
    public static final int AssigningAgencyOrDepartmentCodeSeq = 0x0040003A;
    ...
    /** (0040,0500) VR=SQ Scheduled Specimen Sequence */
    public static final int ScheduledSpecimenSeq = 0x00400500;

    /** (0040,050A) VR=LO Specimen Accession Number (Retired) */
    ...
    public static final int IssuerOfTheContainerIdentifierSeq = 0x00400513;

    /** (0040,0515) VR=SQ Alternate Container Identifier Sequence */
    public static final int AlternateContainerIdentifierSeq = 0x00400515;

    /** (0040,0518) VR=SQ Container Type Code Sequence */
    public static final int ContainerTypeCodeSeq = 0x00400518;
    ...
    public static final int ContainerComponentSeq = 0x00400520;

    /** (0040,0550) VR=SQ Specimen Sequence (Retired) */
    ...
    /** (0040,0560) VR=SQ Specimen Description Sequence */
    public static final int SpecimenDescriptionSeq = 0x00400560;

    /** (0040,0562) VR=SQ Issuer of the Specimen Identifier Sequence */
    public static final int IssuerOfTheSpecimenIdentifierSeq = 0x00400562;

    /** (0040,0600) VR=LO Specimen Short Description */
    public static final int SpecimenShortDescription = 0x00400600;

    /** (0040,0602) VR=UT Specimen Detailed Description */
    public static final int SpecimenDetailedDescription = 0x00400602;

    /** (0040,0610) VR=SQ Specimen Preparation Sequence */
    public static final int SpecimenPreparationSeq = 0x00400610;

    /** (0040,0612) VR=SQ Specimen Preparation Step Content Item Sequence */
    public static final int SpecimenPreparationStepContentItemSeq = 0x00400612;

    /** (0040,0620) VR=SQ Specimen Localization Content Item Sequence */
    public static final int SpecimenLocalizationContentItemSeq = 0x00400620;

    /** (0040,06FA) VR=LO Slide Identifier (Retired) */
    ...
    public static final int ReasonForPerformedProcedureCodeSeq = 0x00401012;
    ...
    /** (0040,4010) VR=DT Scheduled Procedure Step Modification Date and Time */
    public static final int SPSModificationDateandTime = 0x00404010;
    ...
    /** (0040,9094) VR=SQ Referenced Image Real World Value Mapping Sequence */
    public static final int RefImageRealWorldValueMappingSeq = 0x00409094;
    ...
    public static final int AuthorObserverSeq = 0x0040A078;

    /** (0040,A07A) VR=SQ Participant Sequence */
    public static final int ParticipantSeq = 0x0040A07A;

    /** (0040,A07C) VR=SQ Custodial Organization Sequence */
    public static final int CustodialOrganizationSeq = 0x0040A07C;

    /** (0040,A080) VR=CS Participant Type */
    public static final int ParticipantType = 0x0040A080;

    /** (0040,A082) VR=DT Participant DateTime */
    public static final int ParticipantDateTime = 0x0040A082;
    ...
    /** (0040,A090) VR=SQ Equivalent CDA Document Sequence */
    public static final int EquivalentCDADocumentSeq = 0x0040A090;
    ...
    public static final int HL7StructuredDocumentReferenceSeq = 0x0040A390;
    ...
    public static final int HL7DocumentTypeCodeSeq = 0x0040E006;

    /** (0040,E010) VR=UT Retrieve URI */
    public static final int RetrieveURI = 0x0040E010;

    /** (0040,E011) VR=UI Retrieve Location UID */
    ...
    /** (0048,0006) VR=UL Total Pixel Matrix Columns */
    public static final int TotalPixelMatrixColumns = 0x00480006;

    /** (0048,0007) VR=UL Total Pixel Matrix Rows */
    public static final int TotalPixelMatrixRows = 0x00480007;

    /** (0048,0008) VR=SQ Total Pixel Matrix Origin Sequence */
    public static final int TotalPixelMatrixOriginSeq = 0x00480008;

    /** (0048,0010) VR=CS Specimen Label in Image */
    ...
    public static final int IlluminatorTypeCodeSeq = 0x00480100;
    ...
    public static final int OpticalPathSeq = 0x00480105;
    ...
    public static final int IlluminationColorCodeSeq = 0x00480108;

    /** (0048,0110) VR=SQ Specimen Reference Sequence */
    public static final int SpecimenReferenceSeq = 0x00480110;
    ...
    public static final int PaletteColorLookupTableSeq = 0x00480120;

    /** (0048,0200) VR=SQ Referenced Image Navigation Sequence */
    public static final int ReferencedImageNavigationSeq = 0x00480200;

    /** (0048,0201) VR=US Top Left Hand Corner of Localizer Area */
    ...
    public static final int OpticalPathIdentificationSeq = 0x00480207;

    /** (0048,021A) VR=SQ Plane Position (Slide) Sequence */
    public static final int PlanePositionSlideSeq = 0x0048021A;

    /** (0048,021E) VR=SL Row Position In Total Image Pixel Matrix */
    public static final int RowPositionInTotalImagePixelMatrix = 0x0048021E;

    /** (0048,021F) VR=SL Column Position In Total Image Pixel Matrix */
    ...
    public static final int ContainerComponentTypeCodeSeq = 0x00500012;
    ...
    /** (0062,0001) VR=CS Segmentation Type */
    public static final int SegmentationType = 0x00620001;

    /** (0062,0002) VR=SQ Segment Sequence */
    public static final int SegmentSeq = 0x00620002;

    /** (0062,0003) VR=SQ Segmented Property Category Code Sequence */
    public static final int SegmentedPropertyCategoryCodeSeq = 0x00620003;

    /** (0062,0004) VR=US Segment Number */
    public static final int SegmentNumber = 0x00620004;

    /** (0062,0005) VR=LO Segment Label */
    public static final int SegmentLabel = 0x00620005;

    /** (0062,0006) VR=ST Segment Description */
    public static final int SegmentDescription = 0x00620006;

    /** (0062,0008) VR=CS Segment Algorithm Type */
    public static final int SegmentAlgorithmType = 0x00620008;

    /** (0062,0009) VR=LO Segment Algorithm Name */
    public static final int SegmentAlgorithmName = 0x00620009;

    /** (0062,000A) VR=SQ Segment Identification Sequence */
    public static final int SegmentIdentificationSeq = 0x0062000A;

    /** (0062,000B) VR=US Referenced Segment Number */
    public static final int RefSegmentNumber = 0x0062000B;
    ...
    /** (0062,000F) VR=SQ Segmented Property Type Code Sequence */
    public static final int SegmentedPropertyTypeCodeSeq = 0x0062000F;

    /** (0062,0010) VR=CS Segmentation Fractional Type */
    public static final int SegmentationFractionalType = 0x00620010;

    /** (0064,0002) VR=SQ Deformable Registration Sequence */
    public static final int DeformableRegistrationSeq = 0x00640002;

    /** (0064,0003) VR=UI Source Frame of Reference UID */
    public static final int SourceFrameOfReferenceUID = 0x00640003;

    /** (0064,0005) VR=SQ Deformable Registration Grid Sequence */
    public static final int DeformableRegistrationGridSeq = 0x00640005;
    ...
    /** (0066,0011) VR=SQ Surface Points Sequence */
    public static final int SurfacePointsSeq = 0x00660011;

    /** (0066,0012) VR=SQ Surface Points Normals Sequence */
    public static final int SurfacePointsNormalsSeq = 0x00660012;

    /** (0066,0013) VR=SQ Surface Mesh Primitives Sequence */
    public static final int SurfaceMeshPrimitivesSeq = 0x00660013;
    ...
    /** (0066,0025) VR=OW Vertex Point Index List */
    public static final int VertexPointIndexList = 0x00660025;

    /** (0066,0026) VR=SQ Triangle Strip Sequence */
    public static final int TriangleStripSeq = 0x00660026;

    /** (0066,0027) VR=SQ Triangle Fan Sequence */
    public static final int TriangleFanSeq = 0x00660027;

    /** (0066,0028) VR=SQ Line Sequence */
    public static final int LineSeq = 0x00660028;

    /** (0066,0029) VR=OW Primitive Point Index List */
    public static final int PrimitivePointIndexList = 0x00660029;

    /** (0066,002A) VR=UL Surface Count */
    public static final int SurfaceCount = 0x0066002A;

    /** (0066,002B) VR=SQ Referenced Surface Sequence */
    public static final int ReferencedSurfaceSeq = 0x0066002B;

    /** (0066,002C) VR=UL Referenced Surface Number */
    public static final int ReferencedSurfaceNumber = 0x0066002C;

    /** (0066,002D) VR=SQ Segment Surface Generation Algorithm Identification Sequence */
    public static final int SegmentSurfaceGenerationAlgorithmIdentificationSeq = 0x0066002D;

    /** (0066,002E) VR=SQ Segment Surface Source Instance Sequence */
    public static final int SegmentSurfaceSourceInstanceSeq = 0x0066002E;

    /** (0066,002F) VR=SQ Algorithm Family Code Sequence */
    public static final int AlgorithmFamilyCodeSeq = 0x0066002F;

    /** (0066,0030) VR=SQ Algorithm Name Code Sequence */
    public static final int AlgorithmNameCodeSeq = 0x00660030;
    ...
    public static final int FacetSeq = 0x00660034;

    /** (0066,0035) VR=SQ Surface Processing Algorithm Identification Sequence */
    public static final int SurfaceProcessingAlgorithmIdentificationSeq = 0x00660035;
    ...
    public static final int BlendingSeq = 0x00700402;

    /** (0070,0403) VR=FL Relative Opacity */
    public static final int RelativeOpacity = 0x00700403;

    /** (0070,0404) VR=SQ Referenced Spatial Registration Sequence */
    public static final int RefSpatialRegistrationSeq = 0x00700404;
    ...
    /** (0070,0086) VR=SQ Content Creator's Identification Sequence */
    public static final int ContentCreatorIdentificationSeq = 0x00700086;
    ...
    /** (0074,1000) VR=CS Unified Procedure Step State */
    public static final int UPSState = 0x00741000;

    /** (0074,1002) VR=SQ Unified Procedure Step Progress Information Sequence */
    public static final int UPSProgressInformationSeq = 0x00741002;

    /** (0074,1004) VR=DS Unified Procedure Step Progress */
    public static final int UPSProgress = 0x00741004;

    /** (0074,1006) VR=ST Unified Procedure Step Progress Description */
    public static final int UPSProgressDescription = 0x00741006;

    /** (0074,1008) VR=SQ Unified Procedure Step Communications URI Sequence */
    public static final int UPSCommunicationsURISeq = 0x00741008;

    /** (0074,100A) VR=ST Contact URI */
    ...
    /** (0074,100E) VR=SQ Unified Procedure Step Discontinuation Reason Code Sequence */
    public static final int UPSDiscontinuationReasonCodeSeq = 0x0074100E;

    /** (0074,1020) VR=SQ Beam Task Sequence */
    public static final int BeamTaskSeq = 0x00741020;

    /** (0074,1022) VR=CS Beam Task Type */
    public static final int BeamTaskType = 0x00741022;

    /** (0074,1024) VR=IS Beam Order Index */
    public static final int BeamOrderIndex = 0x00741024;

    /** (0074,1030) VR=SQ Delivery Verification Image Sequence */
    public static final int DeliveryVerificationImageSeq = 0x00741030;

    /** (0074,1032) VR=CS Verification Image Timing */
    ...
    /** (0074,1038) VR=DS Double Exposure Meterset */
    public static final int DoubleExposureMeterset = 0x00741038;

    /** (0074,103A) VR=DS Double Exposure Field Delta */
    public static final int DoubleExposureFieldDelta = 0x0074103A;

    /** (0074,1040) VR=SQ Related Reference RT Image Sequence */
    public static final int RelatedReferenceRTImageSeq = 0x00741040;

    /** (0074,1042) VR=SQ General Machine Verification Sequence */
    public static final int GeneralMachineVerificationSeq = 0x00741042;

    /** (0074,1044) VR=SQ Conventional Machine Verification Sequence */
    public static final int ConventionalMachineVerificationSeq = 0x00741044;

    /** (0074,1046) VR=SQ Ion Machine Verification Sequence */
    public static final int IonMachineVerificationSeq = 0x00741046;

    /** (0074,1048) VR=SQ Failed Attributes Sequence */
    public static final int FailedAttributesSeq = 0x00741048;

    /** (0074,104A) VR=SQ Overridden Attributes Sequence */
    public static final int OverriddenAttributesSeq = 0x0074104A;

    /** (0074,104C) VR=SQ Conventional Control Point Verification Sequence */
    public static final int ConventionalControlPointVerificationSeq = 0x0074104C;

    /** (0074,104E) VR=SQ Ion Control Point Verification Sequence */
    public static final int IonControlPointVerificationSeq = 0x0074104E;

    /** (0074,1050) VR=SQ Attribute Occurrence Sequence */
    public static final int AttributeOccurrenceSeq = 0x00741050;
    ...
    /** (0074,1200) VR=CS Scheduled Procedure Step Priority */
    public static final int SPSPriority = 0x00741200;

    /** (0074,1202) VR=LO Worklist Label */
    ...
    /** (0074,1210) VR=SQ Scheduled Processing Parameters Sequence */
    public static final int ScheduledProcessingParametersSeq = 0x00741210;

    /** (0074,1212) VR=SQ Performed Processing Parameters Sequence */
    public static final int PerformedProcessingParametersSeq = 0x00741212;

    /** (0074,1216) VR=SQ Unified Procedure Step Performed Procedure Sequence */
    public static final int UPSPerformedProcedureSeq = 0x00741216;

    /** (0074,1220) VR=SQ Related Procedure Step Sequence */
    public static final int RelatedProcedureStepSeq = 0x00741220;

    /** (0074,1222) VR=LO Procedure Step Relationship Type */
    ...
    /** (0074,1242) VR=CS SCP Status */
    public static final int SCPStatus = 0x00741242;

    /** (0074,1244) VR=CS Subscription List Status */
    public static final int SubscriptionListStatus = 0x00741244;

    /** (0074,1246) VR=CS Unified Procedure Step List Status */
    ...
    /** (0400,0105) VR=DT Digital Signature Date Time */
    ...
    public static final int DigitalSignaturePurposeCodeSeq = 0x04000401;

    /** (0400,0402) VR=SQ Referenced Digital Signature Sequence */
    public static final int RefDigitalSignatureSeq = 0x04000402;

    /** (0400,0403) VR=SQ Referenced SOP Instance MAC Sequence */
    public static final int RefSOPInstanceMACSeq = 0x04000403;
    ...
    public static final int OriginalAttributesSeq = 0x04000561;
    ...
    /** (0400,0564) VR=LO Source of Previous Values */
    ...
    /** (300A,0140) VR=FL Table Top Pitch Angle */
    public static final int TableTopPitchAngle = 0x300A0140;

    /** (300A,0142) VR=CS Table Top Pitch Rotation Direction */
    public static final int TableTopPitchRotationDirection = 0x300A0142;

    /** (300A,0144) VR=FL Table Roll Pitch Angle */
    public static final int TableTopRollAngle = 0x300A0144;

    /** (300A,0146) VR=CS Table Roll Pitch Rotation Direction */
    ...
    public static final int MotionSynchronizationSeq = 0x300A0410;
    ...
    public static final int DigitalSignaturesSeq = 0xFFFAFFFA;
