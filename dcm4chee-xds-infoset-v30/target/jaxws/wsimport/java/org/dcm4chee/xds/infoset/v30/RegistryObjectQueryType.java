    ...
    extends FilterQueryType
{
    ...
    @XmlElement(name = "SlotBranch", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<SlotBranchType> slotBranch;
    @XmlElement(name = "NameBranch", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected InternationalStringBranchType nameBranch;
    @XmlElement(name = "DescriptionBranch", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected InternationalStringBranchType descriptionBranch;
    @XmlElement(name = "VersionInfoFilter", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected FilterType versionInfoFilter;
    @XmlElement(name = "ClassificationQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<ClassificationQueryType> classificationQuery;
    @XmlElement(name = "ExternalIdentifierQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<ExternalIdentifierQueryType> externalIdentifierQuery;
    @XmlElement(name = "ObjectTypeQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected ClassificationNodeQueryType objectTypeQuery;
    @XmlElement(name = "StatusQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected ClassificationNodeQueryType statusQuery;
    @XmlElement(name = "SourceAssociationQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected List<AssociationQueryType> sourceAssociationQuery;
    @XmlElement(name = "TargetAssociationQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
