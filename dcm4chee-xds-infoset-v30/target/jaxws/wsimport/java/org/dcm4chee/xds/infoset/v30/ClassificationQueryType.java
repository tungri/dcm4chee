    ...
    extends RegistryObjectQueryType
{
    ...
    @XmlElement(name = "ClassificationSchemeQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected ClassificationSchemeQueryType classificationSchemeQuery;
    @XmlElement(name = "ClassifiedObjectQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
    protected RegistryObjectQueryType classifiedObjectQuery;
    @XmlElement(name = "ClassificationNodeQuery", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0")
